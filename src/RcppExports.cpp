...
RcppExport SEXP _reemsplots2_tiles2contours(SEXP tilesSEXP, SEXP ratesSEXP, SEXP seedsSEXP, SEXP marksSEXP, SEXP distmSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_reemsplots2_tiles2contours", (DL_FUNC) &_reemsplots2_tiles2contours, 5},
    {NULL, NULL, 0}
};

RcppExport void R_init_reemsplots2(DllInfo *dll) {
